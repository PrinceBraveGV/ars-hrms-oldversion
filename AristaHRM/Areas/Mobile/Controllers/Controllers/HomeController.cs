...
namespace AristaHRM.Areas.Mobile.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult Register()
        {
            ...
            return View("MobileRegister", new KaryawanModel { Perusahaan = Nama_Perusahaan, Cabang = Nama_Cabang });
        }
            ...
            if (ModelState.IsValid)
            {
                ...
                if (No_Induk == null)
                {
                    ...
                    try
                    {
                        ...
                        Msg.Append("<br /><br />");
                        Msg.Append("<a href=\"" + string.Format("http://202.148.16.206:444/Home/InputPassword/{0}", NIK) + "\">" + string.Format("http://202.148.16.206:444/Home/InputPassword/{0}", NIK) + "</a>"); // => ubah localhost dengan alamat situs remote SMTP server
                        Msg.Append("<br /><br />");
