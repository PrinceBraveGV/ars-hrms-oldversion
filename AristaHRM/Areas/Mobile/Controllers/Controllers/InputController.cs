            ...
            if (ModelState.IsValid)
            {
                ...
                if (Parameter == null)
                {
                    ...
                    try
                    {
                        ...
                        Msg.Append("<br /><br />");
                        Msg.Append("<a href=\"" + string.Format("http://202.148.16.206:444/Home/SettingPass/{0}", NIK) + "\">" + string.Format("http://202.148.16.206:444/Home/SettingPass/{0}", NIK) + "</a>"); // => ubah localhost dengan alamat situs remote SMTP server
                        Msg.Append("<br /><br />");
