<%@ Page Title="Laporan SPD F2" Language="C#" MasterPageFile="~/Areas/SPPD/Master/Left_Site.Master" AutoEventWireup="true" CodeBehind="spd2.aspx.cs" Inherits="SPD.Form.spd2" %>
...
*SettingsBehavior AllowFocusedRow="True" --%>
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataDateColumn FieldName="Tanggal_Pengajuan" Caption="Tgl Pengajuan" VisibleIndex="10" PropertiesDateEdit-DisplayFormatString="d MMM yyyy">
                             ...
                             <dx:GridViewDataTextColumn Caption="Option" Name="Option" VisibleIndex="12" Width="150px">
                                <DataItemTemplate>
