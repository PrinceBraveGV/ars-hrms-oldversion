<%@ Page Title="SPD F1 All Data" Language="C#" MasterPageFile="~/Areas/SPPD/Master/Left_Site.Master" AutoEventWireup="true" CodeBehind="ALLSPD1.aspx.cs" Inherits="SPD.Form.ALLSPD1" %>
...
*SettingsBehavior AllowFocusedRow="True" --%>
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataDateColumn FieldName="Tanggal_Pengajuan" Caption="Tanggal Pengajuan" VisibleIndex="8" PropertiesDateEdit-DisplayFormatString="d MMM yyyy">
                             ...
                             <dx:GridViewDataTextColumn Caption="Option" Name="Option" VisibleIndex="10" Width="110px">
                                <DataItemTemplate>

                                    <asp:LinkButton ID="klikedit" runat="server" >Edit</asp:LinkButton>
                                    |
                                    <asp:LinkButton ID="klikdelete" runat="server">Delete</asp:LinkButton>
                                    |
                                    <asp:LinkButton ID="klikprint" runat="server" >View</asp:LinkButton>
