...
namespace AristaHRM.Controllers
{
    ...
    public class SupervisorController : Controller
    {
        ...
        public string Email, Email_Perusahaan, Email_Atasan, Email_Supervisor, Email_Advisor, Email_User, Email_Temp;
        ...
        public ActionResult PengajuanPartial()
        {
            ...
            string Jenis_Cuti = (Request.Params["Jenis_Cuti"] ?? String.Empty).ToString();
            return PartialView("_Pengajuan", new CutiModel { Status_Nikah = Status_Nikah_T, Agama = Agama_T, Jenis_Kelamin = Jenis_T, NIK = NIK, Jenis_Cuti = Jenis_Cuti });
        }
        #endregion
        ...
        public ActionResult Pengajuan(CutiModel model, string url)
        {
            ...
            using (var conn = new SqlConnection(connstring))
            {
                ...
                if (string.IsNullOrEmpty(model.Keperluan) && model.Jenis_Cuti == "Cuti Tahunan")
                {
                ...
                {
                    ViewData["ErrorMsg"] = "Data karyawan ybs harus dilengkapi terlebih dahulu sebelum dapat melakukan pengajuan cuti.";
                    model.NIK = NIK;
                    SetPrivilege();
                    return View(model);
                }

                if (!string.IsNullOrEmpty(model.Nama_Karyawan) && !string.IsNullOrEmpty(model.Jenis_Cuti))
                {
                    ...
                    try
                    {
                        ...
                        // setting SMTP server
                        if (model.Jenis_Cuti != "3" && !Email.Contains("$$$$$") && !Email_Perusahaan.Contains("$$$$$"))
                        {
                            try
                            {
        ...
        public ActionResult ApprovalKhususPartial()
        {
            ...
            using (var conn = new SqlConnection(connstring))
            {
                ...
                catch (SqlException ex)
                {
                    ...
                    ViewData["ErrorMsg"] = "Terjadi kegagalan koneksi database saat memproses data. Pesan: \"" + ex.Message + "\"";
                    SetPrivilege();
                    return PartialView("_ApprovalKhusus");
                }
                catch (Exception e)
                {
                    // jika terdapat gangguan lainnya
                ...
                var model = (from Approval in DB.TT_Approval_K
                             where (Approval.Nama_Atasan == User.Identity.Name || Approval.Nama_Supervisor == User.Identity.Name || Approval.Pemberi == Nama_Atasan)
                             && (Approval.Nama_Karyawan != User.Identity.Name)
                             select Approval);
                ...
                if (!string.IsNullOrEmpty(Nama_Supervisor))
                    model = (from Approval in DB.TT_Approval_K
                             where (Approval.Nama_Atasan == User.Identity.Name || Approval.Nama_Supervisor == User.Identity.Name || Approval.Pemberi == Nama_Supervisor)
                             && (Approval.Nama_Karyawan != User.Identity.Name)
                             select Approval);
        ...
        public ActionResult MultiKhususPartial()
        {
            ...
            using (var conn = new SqlConnection(connstring))
            {
                ...
                catch (SqlException ex)
                {
                    ...
                    ViewData["ErrorMsg"] = "Terjadi kegagalan koneksi database saat memproses data. Pesan: \"" + ex.Message + "\"";
                    SetPrivilege();
                    return PartialView("_MultiKhusus");
                }
                catch (Exception e)
                {
                    // jika terdapat gangguan lainnya
        ...
        public ActionResult SetujuMSCK(String[] arg, CutiModel model)
        {
            ...
            foreach (String idc in arg)
            {
                ...
                using (var conn = new SqlConnection(connstring))
                {
                    ...
                    Msg.Append("Yth. " + Nama_Karyawan + ",");
                    Msg.Append("<br /><br />");
                    Msg.Append("Permohonan cuti khusus dengan kode # " + ID_Cuti + " telah disetujui oleh atasan (" + ApprovedBy + ") pada tanggal " + Tgl_Setuju.ToLongDateString() + ".<br />");
                    Msg.Append("<br /><br />");
                    Msg.Append("Atas perhatiannya kami mengucapkan terima kasih.");
                    Msg.Append("<br /><br /><br /><br />");
                    Msg.Append("Jakarta, " + string.Format("{0:dd MMMM yyyy}", DateTime.Now));
        ...
        public ActionResult ApprovalTahunanPartial()
        {
            ...
            using (var conn = new SqlConnection(connstring))
            {
                ...
                catch (SqlException ex)
                {
                    ...
                    ViewData["ErrorMsg"] = "Terjadi kegagalan koneksi database saat memproses data. Pesan: \"" + ex.Message + "\"";
                    SetPrivilege();
                    return PartialView("_ApprovalTahunan");
                }
                catch (Exception e)
                {
                    // jika terdapat gangguan lainnya
        ...
        public ActionResult MultiTahunanPartial()
        {
            ...
            using (var conn = new SqlConnection(connstring))
            {
                ...
                catch (SqlException ex)
                {
                    ...
                    ViewData["ErrorMsg"] = "Terjadi kegagalan koneksi database saat memproses data. Pesan: \"" + ex.Message + "\"";
                    SetPrivilege();
                    return PartialView("_MultiTahunan");
                }
                catch (Exception e)
                {
                    // jika terdapat gangguan lainnya
        ...
        public ActionResult SetujuCT(string id, CutiModel model)
        {
            ...
            if (record != null)
            {
                if (!string.IsNullOrEmpty(record.Values["NIK"]))
                {
                    NIK_Atasan = record.Values["NIK"].ToString();
                }
            }
            ...
            using (var conn = new SqlConnection(connstring))
            {
                ...
                try
                {
                    ...
                    while (sdr.Read())
                    {
                        NIK_Atasan = sdr["NIK"].ToString().Trim();
                        Nama_Atasan = sdr["Nama_Karyawan"].ToString().Trim();
                    }
                }
                finally
        ...
        public ActionResult SetujuMSCT(String[] arg, CutiModel model)
        {
            ...
            foreach (String idc in arg)
            {
                ...
                using (var conn = new SqlConnection(connstring))
                {
                    ...
                    Msg.Append("Yth. " + Nama_Karyawan + ",");
                    Msg.Append("<br /><br />");
                    Msg.Append("Permohonan cuti tahunan dengan kode # " + ID_Cuti + " telah disetujui oleh atasan (" + ApprovedBy + ") pada tanggal " + Tgl_Setuju.ToLongDateString() + ".<br />");
            ...
            return RedirectToAction("MultiTahunanSukses", "Notif");
        }
        #endregion
        ...
        public ActionResult TolakCT(string id, CutiModel model)
        {
            ...
            using (var conn = new SqlConnection(connstring))
            {
                ...
                try
                {
                    ...
                    Msg.Append("Yth. " + Nama_Karyawan + ",");
                    Msg.Append("<br /><br />");
                    Msg.Append("Permohonan cuti tahunan dengan kode # " + ID_Cuti + " telah ditolak oleh atasan (" + User.Identity.Name + ") pada tanggal " + string.Format("{0:dd MMMM yyyy}", DateTime.Now.Date) + ".<br />");
                    Msg.Append("<br /><br />");
                    Msg.Append("Atas perhatiannya kami mengucapkan terima kasih.");
                    Msg.Append("<br /><br /><br /><br />");
                    Msg.Append("Jakarta, " + string.Format("{0:dd MMMM yyyy}", DateTime.Now));
        ...
        public ActionResult RiwayatPartial()
        {
            ...
            using (var conn = new SqlConnection(connstring))
            {
                ...
                catch (SqlException ex)
                {
                    ...
                    return PartialView("_Riwayat", mdl.ToList());
                }
                catch (Exception e)
                {
                    // jika terdapat gangguan lainnya
                ...
                var advisor = DB.TM_Karyawans.Where(x => x.NIK == NIK).Select(x => x.Nama_Advisor).FirstOrDefault();

                //var model = (from Riwayat in DB.TM_Riwayats
                //             where Riwayat.Nama_Karyawan == User.Identity.Name || Riwayat.Pemberi == Nama_Atasan || Riwayat.Atasan == Nama_Atasan
                //             || Riwayat.Approved_By == Nama_Atasan
                //             select Riwayat);
                ...
                var bawahan = (from kar in DB.TM_Karyawans
                                   where kar.Nama_Supervisor == User.Identity.Name
                                   select kar.Nama_Karyawan).ToList();

                var model = (from Riwayat in DB.TM_Riwayats
                             join Karyawan in DB.TM_Karyawans
                             on Riwayat.NIK equals Karyawan.NIK
                             where (Riwayat.Nama_Karyawan == User.Identity.Name || Riwayat.Approved_By == Nama_Supervisor
                             || Riwayat.Pemberi == Nama_Atasan || Riwayat.Atasan == Nama_Atasan
                             || Riwayat.Approved_By == Nama_Atasan) && Karyawan.Tgl_Resign == null
                             group Riwayat by Riwayat.ID_Cuti into gr
                             select gr.FirstOrDefault()).ToList();

                // bug 180126: nama atasan diganti, seluruh pengajuan sebelumnya selain ybs menghilang
                ...
                // addendum 170614: apabila supervisor ybs memiliki bawahan, maka seluruh data riwayat bawahan perlu disertakan

                if (bawahan != null && bawahan.Count > 0)
                {
                    foreach (var items in bawahan)
                    {
                        var tambahan = (from Riwayat in DB.TM_Riwayats
                                        join Karyawan in DB.TM_Karyawans
                                        on Riwayat.NIK equals Karyawan.NIK
                                        where Riwayat.Nama_Karyawan == items && Karyawan.Tgl_Resign == null
                                        group Riwayat by Riwayat.ID_Cuti into gr
                                        select gr.FirstOrDefault()).ToList();

                        // gabungkan data existing dengan data hasil pencarian per karyawan
                        model.AddRange(tambahan);
                        model.OrderByDescending(x => x.Tgl_Pengajuan);
                    }
                }

                return PartialView("_Riwayat", model);
            }
        }
        #endregion
        ...
        public ActionResult SisaTahunan(FindModel model)
        {
            if (!string.IsNullOrEmpty(model.NIK))
            {
                ...
                if (!Regex.IsMatch(NIK, @"^\d+$"))
                {
                    // yang dimasukkan bukanlah NIK, melainkan nama karyawan
                    var nomor = DB.TM_Karyawans.Where(x => x.Nama_Karyawan == NIK).Select(x => x.NIK).FirstOrDefault();
                    if (nomor != null)
                    {
                        NIK = nomor;
                        Privilege = DB.TM_Karyawans.Where(x => x.Nama_Karyawan == NIK).Select(x => x.Privilege).FirstOrDefault();
                    }
                }
                ...
                using (var conn = new SqlConnection(connstring))
                {
                    ...
                    try
                    {
                        ...
                        while (sdr.Read())
                        {
                            ...
                            Nama_Supervisor = sdr["Nama_Supervisor"].ToString().Trim();
                            Tgl_Masuk = Convert.ToDateTime(sdr["Tgl_Masuk"]);
                            Privilege = string.IsNullOrEmpty(Privilege) ? sdr["Privilege"].ToString().Trim() : Privilege;
                            if (!string.IsNullOrEmpty(sdr["Tgl_Resign"].ToString()))
                            {
                                Tgl_Resign = Convert.ToDateTime(sdr["Tgl_Resign"]);
                            }
        ...
        #region Data Status Pengajuan Cuti
        public ActionResult DataSPCK()
        {
            if (!Request.IsAuthenticated)
            {
                return RedirectToAction("UserSession", "Home", new { ReturnUrl = Request.Url.PathAndQuery.ToString() });
        ...
        public ActionResult DataSPCKPartial()
        {
            ...
            using (var conn = new SqlConnection(connstring))
            {
                ...
                catch (SqlException ex)
                {
                    ...
                    ViewData["ErrorMsg"] = "Terjadi kegagalan koneksi database saat memproses data. Pesan: \"" + ex.Message + "\"";
                    SetPrivilege();
                    return PartialView("DataSPCKPartial", model.ToList());
                }
                catch (Exception e)
                {
                    // jika terdapat gangguan lainnya
        ...
        public ActionResult DataSPCTPartial()
        {
            ...
            using (var conn = new SqlConnection(connstring))
            {
                ...
                catch (SqlException ex)
                {
                    ...
                    ViewData["ErrorMsg"] = "Terjadi kegagalan koneksi database saat memproses data. Pesan: \"" + ex.Message + "\"";
                    SetPrivilege();
                    return PartialView("DataSPCTPartial", model.ToList());
                }
                catch (Exception e)
                {
                    // jika terdapat gangguan lainnya
